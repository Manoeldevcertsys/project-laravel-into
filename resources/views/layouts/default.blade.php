...
<head>
    ...
    <meta
        ...
        content="ie=edge"
    >
    <title>My Store - Sua loja exclusiva Razer</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="flex flex-col h-screen justify-betwee">
    ...
    <footer class="text-gray-600 inset-x-0 bottom-0 bg-gray-100">
