        ...
        <div class="lg:w-2/4 w-full mx-auto overflow-auto">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update', $product->id)}}">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            <label for="name" class="leading-7 text-sm text-gray-600">Upload da capa</label>
                    ...
                    <div class="p-2 w-full">
                        ...
                        <div class="p-2 w-full flex items-center justify-center mb-2">
                            <img id="image-preview" class="w-64 h-64 object-contain object-center rounded" src="{{ \Illuminate\Support\Facades\Storage::url($product->cover) }}" alt="{{ $product->name }}">
                        </div>
                    </div>
                    ...
                    <div class="p-2 w-full">
                        <button
                        type="submit"
                            class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Alterar</button>
                    </div>
